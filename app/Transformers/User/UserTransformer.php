...
class UserTransformer extends TransformerAbstract
{
	...
	public function transform($user): array
	{
		...
		return [
			...
			'contactType' => (!empty(@$user->staff)) ? @$user->staff->contactTypeId :(!empty(@$user->familyMember->contactTypeId))?@$user->familyMember->contactTypeId:"" ,
			'contactTime' => (!empty(@$user->staff)) ?  @$user->staff->contactTime->name : (!empty(@$user->familyMember))?@$user->familyMember->contactTime->name:"",
