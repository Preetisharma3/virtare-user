        ...
        try {
            if (!$familyId) {
                ...
                $familyMember = [
                    ...
                    'createdBy' => Auth::id(), 'userId' => $fam->id, 'udid' => $udid,'vital'=>$request->input('vitalAuthorization'),'message'=>$request->input('messageAuthorization')
                ];
                ...
                $familyMember = [
                    ...
                    'updatedBy' => Auth::id(),'vital'=>$request->input('vitalAuthorization'),'message'=>$request->input('messageAuthorization'),
                ];
