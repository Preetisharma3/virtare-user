...
class CreateGetPatientInsuranceProcedure extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $procedure = "DROP PROCEDURE IF EXISTS `getPatientInsurance`;";
        DB::unprepared($procedure);
        $procedure = "
        CREATE PROCEDURE `getPatientInsurance`(In idx INT)
        BEGIN
    ...
    {
        Schema::dropIfExists('get_patient_insurance_procedure');
    }
}
