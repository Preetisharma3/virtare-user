...
class CreatePatientCriticalNotesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('patientCriticalNotes', function (Blueprint $table) {
            $table->id();
            $table->string('udid');
    ...
    {
        Schema::dropIfExists('patientCriticalNotes');
    }
}
